...
- All releases, including minor and patch releases, may modify the presets in a
  way that causes Oxfmt and/or Oxlint to raise new formatting and/or linting
  concerns that you must address.
- All releases, including minor and patch releases, may require you to upgrade
  Oxfmt and/or Oxlint to a newer minor or patch version to remain compatible
  with the presets.
...
[unreleased]: https://github.com/rainstormy/presets-oxc
